...
<img src='/img/2023-03-25-vault-on-k8s/vault-init-01' style="height: 931px;margin-left: 0px;"/>
...
<img src='/img/2023-03-25-vault-on-k8s/vault-ui-01' style="height: 1124px;margin-left: 0px;"/>

Use root token to login
<img src='/img/2023-03-25-vault-on-k8s/vault-ui-02' style="height: 1124px;margin-left: 0px;"/>

# Next
Ends here, will continue the kubernetes engine enablement and vault inject agent in next blog.s
